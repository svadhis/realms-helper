...
<div class="info info-left">
    <div class="text">This web app is meant</div>
</div>
<div class="info info-right">
    <div class="text">to be used on a phone</div>
</div>
    <!--The Main Thing-->
    <div id="wrapper">
        <div class="phone view_1" id="phone_1">
			<div class="camera"></div>
			<main class="h-screen sm:h-full overflow-hidden flex flex-col border-blue-700 border-pink-700 border-orange-700 border-green-700">
				...
				<div class="absolute top-1/2 left-0 right-0 h-1 {activePlayer == 2 || activePlayer == 4 ? 'rotate-180' : ''}">
					<input
						...
						step="1"
						id="attack-range"
						on:pointerdown={_ => showScale('attack')}
						on:touchstart={_ => showScale('attack')}
						on:pointerup={_ => hideScale('attack')}
					...
					<input
						...
						step="1"
						id="attack-range"
						on:pointerdown={_ => showScale('money')}
						on:touchstart={_ => showScale('money')}
						on:pointerup={_ => hideScale('money')}
